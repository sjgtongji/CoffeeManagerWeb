<%@ Page Language="C#"  MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OrderManager.aspx.cs" Inherits="OrderManager" %>
                                    ...
                                    <%if (listOrderDTO != null)
                                      {
                                          foreach (var item in listOrderDTO)
                                          {
                                            ...
                                            <tr class="eachRow">
                                                ...
                                                <td> <%=item.orderId%></td>
                                                <td><%=item.memberName + GetCustomerName(item.memberAddressUUID)%></td>
                                                <td><%=item.telephone%></td>
                                                <td><%=item.createTime.ToString("yyyy-MM-dd HH:mm")%></td>
                                                <td><%=GetPayStatus(item.payStatus)%></td>
                                                <td><%=GetBuyCount(item.memberUUID)%></td>
