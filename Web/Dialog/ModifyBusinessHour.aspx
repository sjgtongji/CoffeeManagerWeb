<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyBusinessHour.aspx.cs" Inherits="Dialog_ModifyBusinessHour" %>
...
<div class="p20">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <input type="text" id="allowOrderNumber" name="allowOrderNumber" placeholder="" value="<%=objBusinessHourWeek.AllowOrderNumber %>"/>
            </div>
        </div>
        <div class="form-group">
