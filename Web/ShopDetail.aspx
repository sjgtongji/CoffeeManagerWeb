<%@ Page Language="C#" masterpagefile="~/MasterPage.master"  AutoEventWireup="true" CodeFile="ShopDetail.aspx.cs" Inherits="ShopDetail" %>
                    ...
                    <div class="row">
                        ...
                        <div id="Contenter" class="contenter cell fs14 query_order">
                            <form class="form-horizontal" id="resForm">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="alphabet">
                                        商店编号*：</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="alphabet" name="alphabet" placeholder="商店编号" value="<%=restaurant != null ? restaurant.alphabet : string.Empty%>" required />
                                    </div>
                                </div>
                                <div class="form-group">
