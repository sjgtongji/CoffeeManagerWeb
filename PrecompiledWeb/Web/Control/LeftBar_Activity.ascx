<%@ control language="C#" autoeventwireup="true" inherits="Control_LeftBar_Activity, App_Web_leftbar_activity.ascx.cc961b29" %>
...
<div id="sidebar" class="sidebar">
    ...
    <ul class="nav nav-list">
        <li class="active <%=CheckMenuOpen(new string[] { "/ShopManage.aspx","/OrderManager.aspx"})?"open":"" %>">
            <a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text">
                咖啡</span><b class="arrow icon-angle-down"></b></a>
            <ul class="submenu" style="<%=CheckMenuOpen(new string[] { "/ShopManage.aspx","/OrderManager.aspx"})?"": "display:none" %>">
